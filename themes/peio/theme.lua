...
local theme_dir = "~/.config/awesome/themes/peio"
...
theme.accept = theme_dir.."/icons/ok.png"
theme.cancel = theme_dir.."/icons/cancel.png"
theme.lock = theme_dir.."/icons/lock.png"
theme.logout = theme_dir.."/icons/logout.png"
